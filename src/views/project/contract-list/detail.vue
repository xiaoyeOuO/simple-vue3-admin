...
const modulesData = ref([
  {
    ...
    testStartTime: '2024-04-01',
    testCompleteTime: '2024-04-15',
    sort: 1,
    ...
    children: [
      {
        ...
        testStartTime: '2024-03-10',
        testCompleteTime: '2024-03-25',
        sort: 1,
        parentId: 1,
        projectId: projectId.value,
        statistic: {
      ...
      },
      {
        ...
        testStartTime: '2024-03-25',
        testCompleteTime: '2024-04-10',
        sort: 2,
        parentId: 1,
        projectId: projectId.value,
        statistic: {
  ...
  },
  {
    ...
    testStartTime: '2024-04-20',
    testCompleteTime: '2024-05-10',
    sort: 2,
    projectId: projectId.value,
    statistic: {
      allCount: 6,
  ...
  },
  {
    ...
    testStartTime: '2024-02-10',
    testCompleteTime: '2024-02-20',
    sort: 3,
    projectId: projectId.value,
    statistic: {
      allCount: 0,
